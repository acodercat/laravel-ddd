...
return [
    ...
    |
    | Available meta drivers: fluent|annotations|yaml|xml|config|static_php|php|SimplifiedXml
    |
    ...
    */
    'managers'                   => [
        'default' => [
            ...
            'namespaces'    => [],
//            'paths'         => [
//                base_path('app/Infrastructure/Persistence/Doctrine/PhysicalExamine')
//            ],
//            'paths'         => [base_path('app/Infrastructure/Persistence/Doctrine/PhysicalExamine') => 'App\Domain\Model\PhysicalExamine'],
